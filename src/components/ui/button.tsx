...
export function Button({
  ...
  return (
    <button
      ...
      disabled={disabled}
      className={cn(
        "inline-flex h-11 min-h-[44px] items-center justify-center rounded-xl px-6 text-sm font-bold uppercase tracking-wide tap-target touch-manipulation cursor-pointer transition-[transform,background-color,border-color,color,opacity] duration-100 disabled:cursor-not-allowed disabled:opacity-50",
        variants[variant],
        className,
      )}
    >
